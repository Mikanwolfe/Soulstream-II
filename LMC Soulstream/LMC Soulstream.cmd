@echo off
color 0F
title LMC Soulstream Version 1.1.1
...
:splash13
set splash=     updating the update
goto intro
...
:splash16
set splash=   in cooperation with oghs
goto intro
...
timeout 2 >nul
echo. there about 24-26 or so skills in-game
timeout 2 >nul
echo. so have fun with that. Next is the shop function.
timeout 3 >nul
cls
echo.             %name1%
echo.             Store
echo.      10000 Gold / 10000 Exp 
echo.    
echo.                       Gold  / Inp
...
echo.-----------------------------------
timeout 1 >nul
echo. This is the store interface.
timeout 2 >nul
echo. You have to enter a specific letter/phrase indicated by the "inp"
timeout 2 >nul
echo. For example, if you want to improve your starting health, type in "h"
timeout 2 >nul
echo. The "H/E/D+0" means your base health+bought health
echo. The base health is 100 and will increase once you have bought/obtained a class
timeout 2 >nul
echo. You can also upgrade your skills and obtain/buy classes
timeout 2 >nul
cls
echo.             %name1%
echo.             Store
...
timeout 1 >nul
echo.
echo. Skill Ranks are as follows:
echo. Not Learnt, Novice, F, E, D, C, B, A, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0
echo. Skill power and energy drain increase as the rank goes up.
timeout 3 >nul
echo.
echo. There are three current classes and each have five avaliable skills.
echo. Eweca:  Energy Class,  durable and all-rounded.
echo. Laceda: Attack Class,  Low armour and very dangerous.
echo. Falias: Defence Class, High amour and very tough.
timeout 3 >nul
cls
echo.             %name1%
echo.             Store
...
timeout 1 >nul
echo.
echo. Once a player is done, they can type in "next" to proceed
echo. You can type in "back" to move back
timeout 2 >nul
echo.
echo. The game will Auto-Save after both players have used the shop.
timeout 2 >nul
echo.
echo. That's all for now. This tutorial might be incomplete though
echo. Have fun, Cya,
timeout 4 >nul
