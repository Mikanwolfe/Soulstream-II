...
:setnormal
echo Welcome to Animation Battle by LuminousityMC
...
:getsuga2
if %player2.energy% LSS 220 goto no.energy2
cls
cls
echo.
echo.
...
echo.-----------------------------------
timeout 2 >nul
set/a player1.damage=200
set/a player2.energy-=220
goto selection1
:getsuga1
if %player1.energy% LSS 220 goto no.energy1
cls
echo.
echo.
echo.
