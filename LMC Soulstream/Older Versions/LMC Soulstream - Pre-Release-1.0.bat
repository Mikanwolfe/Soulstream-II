@echo off
color 0F
title LMC Soulstream Version 1.0 Pre-Release ATVPT
...
if %p2.energy% lss 20 ( set/a ai.hla-=30
	set/a ai.res+=60
	)
)
...
::hlycheck
set/a ai.hly=0
if %p2.hly.ct%==0 goto ai.hly5
if not %p2.hly.ct%==0 goto ai.hly4
:ai.hly5
if %p2.hly.sr%==0 goto ai.hly4
...
if %ai.nochoice%==%ai.gen% set mainselect2=genisis
...
:ai.store3
if not %round% lss 5 goto ai.store.hpass

set/a sel=%random% %% 8 + 1	
if %score2% lss 30 set sel=6
if %p2.exp% lss 30 set sel=6
if %sel%==1 goto sh2
if %sel%==3 goto sd2
if %sel%==4 goto store2.srk
if %sel%==5 goto store2.srk
if %sel%==6 goto starti
if %sel%==7 goto starti
if %sel%==8 goto sd2

:ai.store.hpass
set/a sel=%random% %% 10 + 1
if %p2.exp% geq 400 goto store2.skl
if %sel%==1 goto sh2
if %sel%==2 goto sh2
if %sel%==3 goto se2
if %sel%==4 goto sd2	
if %sel%==5 goto sh2
if %sel%==6 goto store2.srk
if %sel%==7 goto store2.srk
if %sel%==8 goto starti
if %sel%==9 goto starti
if %sel%==10 goto sd2
...
:ai.srk.n2
if not %round% lss 5  goto ai.srk.n2c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.att
if %sel%==2 goto store2.srk.att
if %sel%==3 goto store2.srk.att
if %sel%==4 goto store2.srk.res
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.hla
if %sel%==7 goto store2.srk.hla
if %sel%==8 goto store2.srk.sok
if %sel%==9 goto store2
if %sel%==10 goto store2.srk.sok
if %sel%==11 goto store2
if %sel%==12 goto store2
...
if %sel%==2 goto store2.srk.att
if %sel%==3 goto store2.srk.att
if %sel%==4 goto store2.srk.att
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.hla
if %sel%==7 goto store2.srk.hla
if %sel%==8 goto store2.srk.sok
if %sel%==9 goto store2.srk.lig
if %sel%==10 goto store2.srk.sok
if %sel%==11 goto store2
if %sel%==12 goto store2
...
:ai.srk.n3
if not %round% lss 5 goto ai.srk.n3c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.att
if %sel%==2 goto store2.srk.att
if %sel%==3 goto store2.srk.att
...
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.hla
if %sel%==7 goto storer
if %sel%==8 goto store2.srk.att
if %sel%==9 goto store2
if %sel%==10 goto store2
if %sel%==11 goto store2
if %sel%==12 goto store2
:ai.srk.n3c
set/a sel=%random% %% 12 + 1
...
:ai.srk.e2
if not %round% lss 10 goto ai.srk.e2c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.att
if %sel%==2 goto store2.srk.att
if %sel%==3 goto store2.srk.att
...
if %sel%==6 goto store2.srk.hla
if %sel%==7 goto store2.srk.hla
if %sel%==8 goto store2.srk.ice
if %sel%==8 goto store2.srk.msh
if %sel%==8 goto store2.srk.ice
if %sel%==8 goto store2.srk.hly
if %sel%==9 goto store2
if %sel%==10 goto store2.srk.ice
if %sel%==11 goto store2
if %sel%==12 goto store2
:ai.srk.e2c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.att
if %sel%==2 goto store2.srk.ice
if %sel%==3 goto store2.srk.res
if %sel%==4 goto store2.srk.hla
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.hly
if %sel%==7 goto store2.srk.hly
if %sel%==8 goto store2.srk.gen
if %sel%==9 goto store2.srk.gen
if %sel%==10 goto store2.srk.ice
if %sel%==11 goto store2
if %sel%==12 goto store2
...
:ai.srk.e3
if not %round% lss 10 goto ai.srk.e3c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.att
if %sel%==2 goto store2.srk.att
if %sel%==3 goto store2.srk.res	
if %sel%==4 goto store2.srk.hla
if %sel%==5 goto store2.srk.ice
if %sel%==6 goto store2.srk.ice
if %sel%==7 goto store2
if %sel%==8 goto store2.srk.hly
if %sel%==9 goto store2
if %sel%==10 goto store2
if %sel%==11 goto store2
...
:ai.srk.e3c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.ice
if %sel%==2 goto store2.srk.ice
if %sel%==3 goto store2.srk.msh
if %sel%==4 goto store2.srk.msh
if %sel%==5 goto store2.srk.hly
if %sel%==6 goto store2.srk.hly
if %sel%==7 goto store2.srk.gen
if %sel%==8 goto store2.srk.gen
if %sel%==9 goto store2.srk.res
if %sel%==10 goto store2.srk.res
if %sel%==11 goto store2
if %sel%==12 goto store2
...
:ai.srk.l2
if not %round% lss 10 goto ai.srk.l2c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.att
if %sel%==2 goto store2.srk.att
if %sel%==3 goto store2.srk.att
...
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.hla
if %sel%==7 goto store2.srk.lbr
if %sel%==8 goto store2.srk.llc
if %sel%==8 goto store2.srk.msh
if %sel%==8 goto store2.srk.llc
if %sel%==8 goto store2.srk.llb
if %sel%==9 goto store2
if %sel%==10 goto store2.srk.llc
if %sel%==11 goto store2
if %sel%==12 goto store2
:ai.srk.l2c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.llc
if %sel%==2 goto store2.srk.llc
if %sel%==3 goto store2.srk.res
if %sel%==4 goto store2.srk.lbr
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.llb
if %sel%==7 goto store2.srk.llb
if %sel%==8 goto store2.srk.lbl
if %sel%==9 goto store2.srk.lbl
if %sel%==10 goto store2.srk.llc
if %sel%==11 goto store2
if %sel%==12 goto store2
...
:ai.srk.l3
if not %round% lss 10 goto ai.srk.l3c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.att
if %sel%==2 goto store2.srk.att
if %sel%==3 goto store2.srk.res	
if %sel%==4 goto store2.srk.hla
if %sel%==5 goto store2.srk.llc
if %sel%==6 goto store2.srk.llc
if %sel%==7 goto store2.srk.llc
if %sel%==8 goto store2.srk.lbr
if %sel%==9 goto store2
if %sel%==10 goto store2
if %sel%==11 goto store2
if %sel%==12 goto store2
...
if %sel%==3 goto store2.srk.msh
if %sel%==4 goto store2.srk.msh
if %sel%==5 goto store2.srk.lbr
if %sel%==6 goto store2.srk.lbr
if %sel%==7 goto store2.srk.lbl
if %sel%==8 goto store2.srk.lbl
if %sel%==9 goto store2.srk.res
if %sel%==10 goto store2.srk.res
if %sel%==11 goto store2
...
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.hla
if %sel%==7 goto store2.srk.lfbr
if %sel%==8 goto store2.srk.smh
if %sel%==8 goto store2.srk.fsh
if %sel%==8 goto store2.srk.smh
if %sel%==8 goto store2.srk.fbr
if %sel%==9 goto store2
if %sel%==10 goto store2.srk.smh
if %sel%==11 goto store2
if %sel%==12 goto store2
:ai.srk.f2c
set/a sel=%random% %% 12 + 1
if %sel%==1 goto store2.srk.smh
if %sel%==2 goto store2.srk.smh
if %sel%==3 goto store2.srk.res
if %sel%==4 goto store2.srk.fbr
if %sel%==5 goto store2.srk.res
if %sel%==6 goto store2.srk.smh
if %sel%==7 goto store2.srk.fbr
if %sel%==8 goto store2.srk.fsl
if %sel%==9 goto store2.srk.fsl
if %sel%==10 goto store2.srk.smh
if %sel%==11 goto store2
if %sel%==12 goto store2
...
if %sel%==3 goto store2.srk.res	
if %sel%==4 goto store2.srk.hla
if %sel%==5 goto store2.srk.smh
if %sel%==6 goto store2.srk.smh
if %sel%==7 goto store2.srk.smh
if %sel%==8 goto store2.srk.fbr
if %sel%==9 goto store2
if %sel%==10 goto store2
if %sel%==11 goto store2
...
if %sel%==1 goto store2.srk.smh
if %sel%==2 goto store2.srk.smh
if %sel%==3 goto store2.srk.fsh
if %sel%==4 goto store2.srk.fsh
if %sel%==5 goto store2.srk.fbr
if %sel%==6 goto store2.srk.fbr
if %sel%==7 goto store2.srk.fsl
if %sel%==8 goto store2.srk.fsl
if %sel%==9 goto store2.srk.res
if %sel%==10 goto store2.srk.res
if %sel%==11 goto store2
